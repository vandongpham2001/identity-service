...
public class UserNotFoundAdvice {
    ...
    public final BaseApiResponse handleUserNotFoundException(UserNotFoundException ex) {
        final MultiRecordErrorResponseDtoBase response =
                new MultiRecordErrorResponseDtoBase(ErrorCode.USER_NOT_FOUND.getCode(), ex.getMessage());
