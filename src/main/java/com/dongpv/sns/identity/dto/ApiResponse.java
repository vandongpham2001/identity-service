...
public class ApiResponse<T> implements BaseApiResponse {
    ...
    public static <T> ApiResponse<T> ok() {
        return ApiResponse.<T>builder().code(200).status(true).build();
    }
    ...
    public static <T> ApiResponse<T> ok(int code) {
        return ApiResponse.<T>builder().code(code).status(true).build();
    }
    ...
    public static <T> ApiResponse<T> ok(String message) {
        return ApiResponse.<T>builder().code(200).status(true).message(message).build();
    }
    ...
    public static <T> ApiResponse<T> ok(T data) {
        return ApiResponse.<T>builder().code(200).status(true).data(data).build();
    }
    ...
    public static <T> ApiResponse<T> ok(T data, int code) {
        return ApiResponse.<T>builder().code(code).status(true).data(data).build();
    }
    ...
    public static <T> ApiResponse<T> ok(int code, String message) {
        return ApiResponse.<T>builder().code(code).status(true).message(message).build();
    }
