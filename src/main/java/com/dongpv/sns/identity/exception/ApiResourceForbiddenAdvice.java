...
public class ApiResourceForbiddenAdvice {
    @ExceptionHandler(ApiResourceForbiddenException.class)
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public final BaseApiResponse handleApiResourceForbiddenException(ApiResourceForbiddenException ex) {
        final MultiRecordErrorResponseDtoBase response =
                new MultiRecordErrorResponseDtoBase(ErrorCode.API_RESOURCE_FORBIDDEN.getCode(), ex.getMessage());
